...
const seedJobs = [
  ...
  },
  {
    ...
    "description": "About the Team\n\nCustomer Readiness helps customers and partners build the practical skills and confidence to use AI and OpenAI products safely and effectively. The team focuses on role- and skill-based learning paths, practical content, and product experiences that accelerate learning in the workpla...",
    "requirements": [
      "Golang",
      "React",
      "TypeScript",
...
if (typeof window !== "undefined") {
  ...
  window.lastSyncedJobs = "2026-09-04 01:33 AM";
}
